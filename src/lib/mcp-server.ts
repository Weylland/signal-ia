      ...
      },
      {
        ...
        inputSchema: {
          ...
          properties: {
            ...
            llmArticles: { type: "string", enum: ["mistral", "claude"] },
            llmTutos: { type: "string", enum: ["mistral", "claude"] },
            llmTweets: { type: "string", enum: ["mistral", "claude"] },
            llmTranslation: { type: "string", enum: ["mistral", "claude"] },
          },
        },
      },
    ],
