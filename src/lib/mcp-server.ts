      ...
      },
      {
        ...
        inputSchema: {
          ...
          properties: {
            ...
            xTutoCooldownDays: { type: "number" },
            xNewsMaxAgeDays: { type: "number" },
            xGenerateTuto: { type: "boolean" },
            llmArticles: { type: "string", enum: ["mistral", "haiku", "sonnet", "opus"] },
            llmTutos: { type: "string", enum: ["mistral", "haiku", "sonnet", "opus"] },
            llmTweets: { type: "string", enum: ["mistral", "haiku", "sonnet", "opus"] },
            llmTranslation: { type: "string", enum: ["mistral", "haiku", "sonnet", "opus"] },
          },
        },
      },
    ],
